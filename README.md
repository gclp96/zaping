...
| Control | Resultado |
|---|---|
| Archivos de prueba | ✅ 6 aprobados |
| Pruebas | ✅ 40 aprobadas |
| ESLint | ✅ Sin errores |
| Build | ✅ Correcto |
...
- Faltan pruebas automatizadas específicas del formulario frontend de recepción.
...
## PUR-012 — Pruebas automatizadas del formulario frontend de recepción

Objetivos:

1. Probar apertura y cierre del modal.
2. Probar cálculo de cantidades pendientes.
3. Probar validación de cantidad vacía.
4. Probar cantidad mayor que la pendiente.
5. Probar caducidad sin lote.
6. Probar payload enviado al backend.
7. Probar actualización visual después de una recepción exitosa.
