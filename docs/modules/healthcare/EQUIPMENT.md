...
**Versión:** 1.0.0
**Estado:** Approved
**Estado de implementación:** EQUIPMENT ASSIGNMENT DOMAIN DISCOVERY COMPLETE / DOCUMENTED — HC-NEXT-03B COMPLETE / APPROVED — HC-NEXT-03C1 PERSISTENCE / MIGRATION COMPLETE / MERGED — HC-NEXT-03C2 BACKEND BASE COMPLETE / READY FOR REVIEW — HC-NEXT-03C3 NEXT / BLOCKED UNTIL C2 MERGED — PARTIALLY IMPLEMENTED
